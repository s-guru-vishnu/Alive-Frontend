...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Heart2Heal made it so easy to find hospitals in need. I've donated 5 times this year and the process is seamless every time!",
    icon: UserIcon,
    iconColor: '#DC2626',
  ...
  },
  {
    ...
    rating: 5,
    text: "As a hospital administrator, Heart2Heal has revolutionized how we source blood donations. Quick matches and reliable donors across Tamil Nadu!",
    icon: HospitalIcon,
    iconColor: '#10B981',
  ...
  },
  {
    ...
    rating: 5,
    text: "We've seen a 40% improvement in finding donors since using Heart2Heal. The matching algorithm is incredibly accurate for our trauma center.",
    icon: HospitalIcon,
    iconColor: '#F59E0B',
  ...
  },
  {
    ...
    role: 'CMC Vellore',
    rating: 5,
    text: "Heart2Heal has transformed our emergency blood procurement process. We can now find donors within minutes instead of hours.",
    icon: HospitalIcon,
    iconColor: '#06B6D4',
    bgColor: 'bg-cyan-100',
  },
